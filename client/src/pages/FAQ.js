            ...
            <div className="space-y-4">
              <details className="w-full border rounded-lg">
                <summary className="px-4 py-6 ">
                  What are the options of buying courses?
                </summary>
                <p className="px-4 py-6  text-gray-400">
                  You can buy our courses using any bank. You can also pay using
                  paypal, payoneer, visa card, master card.{" "}
                </p>
              </details>
              <details className="w-full border rounded-lg">
                <summary className="px-4 py-6 ">how Can I Login ?</summary>
                <p className="px-4 py-6  text-gray-400">
                  You Can Login directly with your Gmail and Github. You can
                  also login with your email and password if you registered.{" "}
                </p>
              </details>
              <details className="w-full border rounded-lg">
                <summary className="px-4 py-6 ">
                  Will There Be Any courses Added ?
                </summary>
                <p className="px-4 py-6  text-gray-400">
                  Yes, we are constantly trying to more meaningful courses.Our
